 ...
 *
 */
public class GenerateServiceInterface extends GenerateBaseInterface {
	public static final String TEMPLATE_PATH = "template/ServiceInterfaceTemplateFlowerS.txt";
	@Override
