 ...
 *
 */
public class GenereateManagerImplementClass extends GenerateBaseImplementClass {
	public static final String TEMPLATE_PATH = "template/ManagerImplementClassTemplate.txt";
